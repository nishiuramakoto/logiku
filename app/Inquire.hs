...
prologInquireBoolWidget ::  State -> CCNode -> Widget -> Enctype -> Widget
...
prologInquireBoolHtml :: State ->  Term -> CCNode -> CC CCP Handler Html
...
inquirePrologBool :: State -> Term -> CC CCP Handler State
